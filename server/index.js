...
app.delete('/recipe/:foodname/:ingredients/:instructions/:foodimage/:foodtype', async (req, res) => {
    try {
        ...
        // cache the userIndex based on a matching name and email
        const recipeIndex = recipes.findIndex(recipe => recipe.foodname === foodname && recipe.ingredients === ingredients && recipe.instructions === instructions && recipe.foodtype === foodtype && recipe.foodimage === foodimage);
